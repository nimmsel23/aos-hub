...
- Engine: `game/fire/firemap.py` (Taskwarrior `+fire` → Markdown-formatted text messages; overdue separate; grouped per project)
- Bot: `game/fire/firemap_bot.py` (sends text, not files)
...
- Run: `python game/fire/firemap_bot.py daily|weekly|listen|print --scope daily|weekly`

...
**Status:** 🚧 Konzeptphase
**Datum:** 2026-01-02
**Ziel:** Zentraler Sync-Service für alle AlphaOS Taskwarrior tasks → TickTick
...
- Alle AlphaOS tasks leben in Taskwarrior (mit UUIDs)
...
| AlphaOS Bereich | Taskwarrior Tags | TickTick Project | Status |
|-----------------|------------------|------------------|--------|
...
```ini
[Unit]
Description=AlphaOS Taskwarrior ↔ TickTick Sync Daemon
...
```ini
[Unit]
Description=AlphaOS Taskwarrior ↔ TickTick Sync (every 5 minutes)

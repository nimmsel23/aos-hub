...
- [game.md](game.md) - Strategic Maps
...
**Related Agent:**
- **voice-pillar-agent** - αOS agent for VOICE facilitation (interactive sessions via Claude Code)

---

**Last Updated:** 2026-01-10
**αOS Philosophy:** Elliott Hulse (THE VOICE - Pillar #3)

...
const STATIC = [
  ...
  `${SCOPE_PATH}sw.js`,
  "/pwa/door/potential/style.css",
  "/pwa/door/potential/app.js",
...
self.addEventListener("fetch", (event) => {
  ...
  if (
    ...
    url.pathname.startsWith("/pwa/door/potential/") ||
    url.pathname.startsWith("/pwa/door/icon-") ||

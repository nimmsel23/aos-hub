 ...
 */
function hotlist_addWeb(idea, user, userKey) {
  return (typeof door_withUserKey_ === 'function')
    ? door_withUserKey_(userKey, function() { return hotlist_addWeb_(idea, user); })
    : hotlist_addWeb_(idea, user);
}

function hotlist_addWeb_(idea, user) {
 ...
 */
function getPotentialHotIdeas(userKey) {
  return (typeof door_withUserKey_ === 'function')
    ? door_withUserKey_(userKey, function() { return getPotentialHotIdeas_(); })
    : getPotentialHotIdeas_();
}

function getPotentialHotIdeas_() {
  var root = doorGetCentreFolder();
 ...
 */
function doorMovePotentialToPlan(fileIds, userKey) {
  return (typeof door_withUserKey_ === 'function')
    ? door_withUserKey_(userKey, function() { return doorMovePotentialToPlan_(fileIds); })
    : doorMovePotentialToPlan_(fileIds);
}

function doorMovePotentialToPlan_(fileIds) {

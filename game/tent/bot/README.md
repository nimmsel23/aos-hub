...
Domain States (~/.vault/.states/*.json)
    ↓
...
- Check systemd service: `~/aos-hub/game/tent/tentctl status`
- Check logs: `~/aos-hub/game/tent/tentctl logs`
- Verify ALLOWED_USER_ID in .env

**API connection failed:**
- Check Index Node is running: `curl http://127.0.0.1:8799/health`
- Verify INDEX_API_BASE in .env
- Check domain-states exist: `ls ~/vault/.states/`

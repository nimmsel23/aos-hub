...
#
# Canonical location: game/fire/setup-fire-reports.sh
# Kept separate from game/fire/setup-fire-map.sh (which installs report.fire).
...
Usage:
  game/fire/setup-fire-reports.sh
